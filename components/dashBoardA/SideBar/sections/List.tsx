...
const List = () => {
  ...
  const PATH_NAME = router.pathname.slice(1);
  console.log(PATH_NAME);

  return (
    <Wrapper>
      <Link href='/dashboard' className='container-icon'>
        <a className={`a ${'dashboard' == PATH_NAME ? 'blue' : null}`}>
      ...
      <Link href='/research' className='container-icon'>
        <a className={`a ${'research' == PATH_NAME ? 'blue' : null}`}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link href='/members' className='container-icon'>
        <a className={`a ${'members' == PATH_NAME ? 'blue' : null}`}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link href='/insight'  className={'container-icon'}>
        <a className={`a ${'insight' == PATH_NAME ? 'blue' : null}`}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link href='/calendar'  className='container-icon'>
        <a className={`a ${'calendar' == PATH_NAME ? 'blue' : null}`}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
